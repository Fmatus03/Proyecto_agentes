...
## Acceptance criteria
- AC01: BrewMaster declara los modulos MVP de la especificacion.
- AC02: BrewMaster declara exactamente 30 pantallas.
- AC03: BrewMaster usa endpoints /api/v1 y acciones REST consistentes.
- AC04: BrewMaster materializa backend, frontend, contratos y pruebas en DEV.
- AC05: BrewMaster usa React + Bootstrap como contrato frontend y no una plantilla heredada.
