...
| Every project and sandbox must declare the project frontend contract. | EV-SRC-001 | `frontend-template-policy.md` |
| Every project has an incremental roadmap and a persisted milestone state. | EV-SRC-001 | `roadmap.md` |
...
| BrewMaster MVP blueprint covers modules, screens, entities, API v1 endpoints and critical transactional rules. | EV-SRC-001 | `brewmaster-coverage.json` |
...
| Milestone gates decide incremental advance using DEV, QA and regression evidence. | EV-SRC-001 | `milestone-gate-report.json` |
